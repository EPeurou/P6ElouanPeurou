...
return [
    ...
    [ // $staticRoutes
        ...
        '/user/confirm' => [[['_route' => 'confirm', '_controller' => 'App\\Controller\\UserController::confirm'], null, ['GET' => 0], null, false, false, null]],
        '/' => [
    ...
    [ // $dynamicRoutes
        ...
        247 => [[['_route' => 'resetpassword', '_controller' => 'App\\Controller\\ResetController::resetPassword'], ['email'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        277 => [[['_route' => 'tricks_show', '_controller' => 'App\\Controller\\TricksController::show'], ['slug'], ['GET' => 0, 'POST' => 1], null, false, true, null]],
        310 => [[['_route' => 'ajaxMainImage', '_controller' => 'App\\Controller\\TricksController::ajaxSupprMainImage'], ['id'], null, null, false, false, null]],
        322 => [[['_route' => 'ajax', '_controller' => 'App\\Controller\\TricksController::ajaxSupprMedia'], ['id'], null, null, false, false, null]],
        335 => [[['_route' => 'tricks_edit', '_controller' => 'App\\Controller\\TricksController::edit'], ['slug'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        360 => [[['_route' => 'tricks_delete', '_controller' => 'App\\Controller\\TricksController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        397 => [[['_route' => 'emailCheck', '_controller' => 'App\\Controller\\UserController::emailCheck'], ['id'], ['GET' => 0], null, false, true, null]],
        416 => [
