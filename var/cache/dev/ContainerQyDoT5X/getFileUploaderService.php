...
class getFileUploaderService extends App_KernelDevDebugContainer
{
    ...
    {
        $container->throw('Cannot autowire service "App\\Service\\FileUploader": argument "$targetDirectory" of method "__construct()" has no type-hint, you should configure its value explicitly.');
    }
}
