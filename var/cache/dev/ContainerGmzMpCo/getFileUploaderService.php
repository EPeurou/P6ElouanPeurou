...
class getFileUploaderService extends App_KernelDevDebugContainer
{
    ...
    {
        $container->throw('Cannot autowire service "App\\Service\\FileUploader": argument "$targetDirectory" of method "__construct()" is type-hinted "string", you should configure its value explicitly.');
    }
}
